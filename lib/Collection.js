...
var {BasicDBObject, BasicDBList, ISODate} = Packages.com.mongodb,
...
function serialize( o ) {
    ...
    if ( decaf.isArray(o) ) {
        ...
        decaf.each(o, function( value ) {
            result.add(serialize(value), index++);
        });
        return result;
    }
...
function xxx() {
//    return BSON.from(BSON.to(o));
//    o = BSON.to(o || {});
//    console.dir(o instanceof BasicDBObject);
//    return o;
